  ...
  function FlatpickrInstance(element, instanceConfig) {
      ...
      function buildTime() {
          ...
          self.hourElement.value = pad(self.latestSelectedDateObj
              ? (extractHours && extractHours(self.latestSelectedDateObj)) || self.latestSelectedDateObj.getHours()
              : self.config.time_24hr
                  ? self.config.defaultHour
                  : military2ampm(self.config.defaultHour));
          self.minuteElement.value = pad(self.latestSelectedDateObj
              ? (extractMinutes && extractMinutes(self.latestSelectedDateObj)) || self.latestSelectedDateObj.getMinutes()
          ...
          if (self.config.enableSeconds) {
              ...
              self.secondElement.value = pad(self.latestSelectedDateObj
                  ? (extractSeconds && extractSeconds(self.latestSelectedDateObj)) || self.latestSelectedDateObj.getSeconds()
